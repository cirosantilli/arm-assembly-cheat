...
....
error 1 at line 12
Makefile:164: recipe for target 'test-add' failed
make: *** [test-add] Error 1
....

Look how nice we are: we even told you that the assert failed at line 12!
...
This is unlike ARMv7, where is is completely optional through <<vfp>>.

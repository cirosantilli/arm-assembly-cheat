...
Tested on Raspbian Lite 2018-11-13.
...
The `ldr` assembly directive can automatically create hidden variables in a place called the "literal pool", and load them from memory with PC relative loads.

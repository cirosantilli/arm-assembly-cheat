...
Clone, configure, build QEMU from source, run all ARMv7 and ARMv8 examples through QEMU user, and assert that they exit with status 0:
...
Described on <<armarmv8>> C1.2.5 "Register names".
...
<<armarmv8>> A1.7 "ARMv8 architecture extensions" says:

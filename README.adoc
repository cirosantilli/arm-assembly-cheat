...
* is required in ARMv7 with `.syntax divided` (the default)
* optional on:
** ARMv7 with `.syntax unified`
** ARMv8

See also:

* https://stackoverflow.com/questions/21652884/is-the-hash-required-for-immediate-values-in-arm-assembly/51987780#51987780
* https://stackoverflow.com/questions/6097958/what-does-the-hash-value-associated-with-the-arm-ldr-instruction-mean/51988091#51988091
